...
const UserProfile = () => {
  ...
  const profilecountry = localStorage.getItem('country')
  const profilestate = localStorage.getItem('state')
  const profilecity = localStorage.getItem('city')
  const profilepincode = localStorage.getItem('pincode')
      ...
      <div className="main-body">
        ...
        <nav aria-label="breadcrumb" className="main-breadcrumb">
          <ol className="breadcrumb">
            <Link to={"/home"}><i class="fa fa-arrow-left" aria-hidden="true" style={{ scale: '2', color: "#0066b2" }}></i></Link>
          </ol>
        </nav>
        {/* /Breadcrumb */}
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <div className="mt-3">
                    <h4>{profilename}</h4>
                    <p className="text-secondary mb-1">{profilecountry}</p>
                    <button onClick={handleLogout} style={{ marginLeft: '1em' }} className="btn btn-outline-danger">Log Out</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <Link to={"/editprofile"}><a className="btn btn-info" href="javascript:void(0)">Edit</a></Link>
                  </div>
                </div>
              </div>
            </div>
